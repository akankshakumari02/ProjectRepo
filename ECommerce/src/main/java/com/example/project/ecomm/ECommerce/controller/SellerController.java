...
public class SellerController
{
   ...
   public ResponseEntity<?> updateProfile(@Valid Principal principal, @RequestBody ProfileDto profileDto)
    ...
    public MappingJacksonValue getProductVariation(@RequestParam("id") Integer id, Principal principal) {
        ProductVariation productVariation=sellerService.getProductVariationById(principal.getName(),id);
    ...
    public ResponseEntity<Object> updateProductVariation(@RequestBody UpdateProductVariationDto updateProductVariationDto,Principal principal) {
    ...
    public MappingJacksonValue viewProductVariationByProductId(@RequestParam Integer id,Principal principal) {
        List<ProductVariation> productVariations=sellerService.getAllProductVariationForProductById(principal.getName(),id);
        SimpleBeanPropertyFilter filter = SimpleBeanPropertyFilter.filterOutAllExcept("id", "product", "quantityAvailable", "price", "image","metadata");
        FilterProvider filters = new SimpleFilterProvider().addFilter("Filter", filter);
